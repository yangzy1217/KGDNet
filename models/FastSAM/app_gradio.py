...
# Description
title = "<center><strong><font size='8'>馃弮 Fast Segment Anything 馃</font></strong></center>"

news = """ # 馃摉 News
        馃敟 2023/06/29: Support the text mode (Thanks for [gaoxinge](https://github.com/CASIA-IVA-Lab/FastSAM/pull/47)).

        馃敟 2023/06/26: Support the points mode. (Better and faster interaction will come soon!)

        馃敟 2023/06/24: Add the 'Advanced options" in Everything mode to get a more detailed adjustment.        
        """  

description_e = """This is a demo on Github project 馃弮 [Fast Segment Anything Model](https://github.com/CASIA-IVA-Lab/FastSAM). Welcome to give a star 猸愶笍 to it.
                
                馃幆 Upload an Image, segment it with Fast Segment Anything (Everything mode). The other modes will come soon.
                
                鈱涳笍 It takes about 6~ seconds to generate segment results. The concurrency_count of queue is 1, please wait for a moment when it is crowded.
                
                馃殌 To get faster results, you can use a smaller input size and leave high_visual_quality unchecked.
                
                馃摚 You can also obtain the segmentation results of any Image through this Colab: [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1oX14f6IneGGw612WgVlAiy91UHwFAvr9?usp=sharing)
                
                馃槡 A huge thanks goes out to the @HuggingFace Team for supporting us with GPU grant.
                
                馃彔 Check out our [Model Card 馃弮](https://huggingface.co/An-619/FastSAM)
                
              """

description_p = """ # 馃幆 Instructions for points mode
                This is a demo on Github project 馃弮 [Fast Segment Anything Model](https://github.com/CASIA-IVA-Lab/FastSAM). Welcome to give a star 猸愶笍 to it.
...
def segment_everything(
    ...
    input_size = int(input_size)  # Ensure imgsz is an integer. Thanks to hysts on HuggingFace.
    w, h = input.size
    ...
    with gr.Tab("Everything mode"):
        ...
        with gr.Row():
            with gr.Column():
                ...
                gr.Markdown("Try some of the examples below 猬囷笍")
